...
**IMPORTANT NOTE:** This assumes that the DL architecture (eg, number of neurons, layers...) have been specified. Determining the optimum architecture is a serious and time consuming task that should be carefully done. Check below https://github.com/miguelperezenciso/DLpipeline#hyperparameter-optimization and the Talos scripts in the jupyter notebook.
